...
// New1 makes a function that can be used in expressions from a function that takes a single argument and returns a single value.
func New1[I, O any](f func(I) O) eval.Func {
